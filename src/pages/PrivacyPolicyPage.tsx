      ...
      <div className="container">
        <div className="legal-page__content">
          ...
          <section aria-labelledby="pp-intro">
            ...
            <p>
              This Privacy Policy describes how <strong>SKILLS LINK LTD</strong>, a company incorporated in England and Wales, operating the Align Nimbly platform (<strong>"Align Nimbly"</strong>, <strong>"we"</strong>,{' '}
            ...
            <p>
              This policy applies to personal data collected through the Align Nimbly website and the
          ...
          <section aria-labelledby="pp-disclosure">
            ...
            <ul className="legal-page__list">
              <li>
                ...
                Align Nimbly is not responsible for the data handling practices of employer partners
          ...
          <section aria-labelledby="pp-contact">
            ...
            <p>
              <strong>Data Protection Contact — Align Nimbly</strong><br />
              Email: <a href="mailto:privacy@alignnimbly.com">privacy@alignnimbly.com</a><br />
              SKILLS LINK LTD<br />
